	...
	quality: {
		...
		stations: {
			...
			legendTitle: (national: string) =>
				`Share of the rain we warned about, against the national ${national}`,
			legendTitleAbsolute: 'Share of the rain we warned about',
			legendNote:
				'The colours compare each station with the national rate: a dot below it is below average, not necessarily a station where the warnings are broken.',
