...
#: Seconds in a gauge slot and in a day.
...
# ---------------------------------------------------------------------------
# Layer B: loading probabilities without materialising a row per dict
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Layer B: the gauge grid, and the outcome window on it
# ---------------------------------------------------------------------------
...
def _recode_stations(rows: dict, scored: Sequence[str]) -> None:
